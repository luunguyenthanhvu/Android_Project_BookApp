package nlu.hmuaf.android_bookapp.animation.add_to_cart;
...
public class CircleAnimation {
    ...
    public CircleAnimation attachActivity(Activity activity) {
        mContextReference = new WeakReference<Activity>(activity);
        return this;
    }

    public CircleAnimation setTargetView(View view) {
        mTarget = view;
        setOriginRect(mTarget.getWidth(), mTarget.getHeight());
        return this;
    }

    private CircleAnimation setOriginRect(float x, float y) {
        originX = x;
        originY = y;
        return this;
    }

    private CircleAnimation setDestRect(float x, float y) {
        destX = x;
        destY = y;
        return this;
    }

    public CircleAnimation setDestView(View view) {
        mDest = view;
        setDestRect(mDest.getWidth(), mDest.getWidth());
        return this;
    }

    public CircleAnimation setBorderWidth(int width) {
        mBorderWidth = width;
        return this;
    }

    public CircleAnimation setBorderColor(int color) {
        mBorderColor = color;
        return this;
    }

    public CircleAnimation setCircleDuration(int duration) {
        mCircleDuration = duration;
        return this;
    }

    public CircleAnimation setMoveDuration(int duration) {
...
//        mTarget.setVisibility(View.VISIBLE);
    ...
    public CircleAnimation setAnimationListener(Animator.AnimatorListener listener) {
