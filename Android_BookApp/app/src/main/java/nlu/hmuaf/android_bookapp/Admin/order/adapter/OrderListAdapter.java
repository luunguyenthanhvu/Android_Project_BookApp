...
public class OrderListAdapter extends RecyclerView.Adapter<OrderListAdapter.OrderViewHolder> {
    ...
    class OrderViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Order order) {
            ...
            if (!order.getProductImageUrl().isEmpty()) {
                Picasso.get().load(order.getProductImageUrl()).into(productImageView);
            }
            ...
            productPriceTextView.setText("Đơn giá: " + order.getPrice());
            productTotalTextView.setText("Thành tiền: " + order.getTotal());
            codeProductTextView.setText(order.getProductId());
